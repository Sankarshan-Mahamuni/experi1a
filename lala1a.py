...
img_path = "Screenshot_20231114-100244_Drive.jpg"
...
img_path = "Screenshot_20231114-100321_Drive.jpg"
img = Image.open(img_path)
img = Image.open(img_path)
# Display the image using Streamlit
st.image(img,  use_column_width=True)
...
img_path ="Screenshot_20231114-100402_Drive.jpg"
img = Image.open(img_path)
...
img_path = "Screenshot_20231114-100424_Drive.jpg"
img = Image.open(img_path)
...
# Open an image file
img_path = "Screenshot_20231114-100513_Drive.jpg"
img = Image.open(img_path)
